...
editstyle = 'assets/styles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 0;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="assets/styles/style.css">\n');
...
function make_wyzz(textareaID) {
  ...
  for (btn in buttonName2) {
    ...
    if(buttonName2[btn] == "separator") {
      ...
      toolbar2 += '<td style="width: 22px;"><img src="assets/images/' +buttonName2[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName2[btn]+ '" id="' +buttonName2[btn]+ '" class="button" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'button\'};" unselectable="on" width="20" height="20"></td>';
      }
  }
  toolbar2 += '<td>&nbsp;</td></tr>';
...
// the foreground color picker
  ...
  toolbar2 += '<div id="colorpicker' + n + '" class="colorpicker" style="display:none">';
    ...
    toolbar2 += '<img class="closebutton" src="assets/images/close.gif" border=0 onclick="closeColorPicker(\'colorpicker' + n + '\')"></div>';
  ...
  toolbar2 += '<img class="closebutton" src="assets/images/close.gif" border=0 onclick="closeColorPicker(\'colorbackpicker' + n + '\')"></div>'; 
  // the font picker
  ...
  toolbar2 += '<img class="closebutton" src="assets/images/close.gif" border=0 onclick="closeColorPicker(\'fontpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '</tr></table><br><img class="closebutton" src="assets/images/close.gif" border=0 onclick="closeColorPicker(\'specialpicker' + n + '\')"></div>'; 
  // the header picker
  ...
  toolbar2 += '<img class="closebutton" src="assets/images/close.gif" border=0 onclick="closeColorPicker(\'headerpicker' + n + '\')"></div>'; 
  ...
  toolbar2 += '<img class="closebutton" src="assets/images/close.gif" border=0 onclick="closeColorPicker(\'helpbox' + n + '\')"></div></td></tr></table>';   
